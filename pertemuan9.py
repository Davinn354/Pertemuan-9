import sqlite3 #import dari sqlite3
from tkinter import Tk, Label, Entry, Button, StringVar, messagebox, ttk
#membuat fungsi 
def create_database():
    conn = sqlite3.connect('nilai_siswa_.db')#menghubungkan data base
    cursor = conn.cursor()
    cursor.execute('''
...
# Fungsi untuk menyimpan data dari input ke database
def submit():
    try:
        nama = nama_var.get()
...
# Fungsi untuk memperbarui data berdasarkan input
def update():
    try:
